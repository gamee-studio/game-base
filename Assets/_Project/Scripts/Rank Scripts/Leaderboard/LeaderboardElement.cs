...
namespace Pancake.GameService
{
    public class LeaderboardElement : MonoBehaviour
    {
        ...
        public virtual void Init(InternalConfig userInternalConfig, int rank, Sprite icon, string userName, int score,
            PopupLeaderboard.ElementColor color, Canvas root, bool self)
        {
