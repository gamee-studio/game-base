...
{
    public class PopupEnterName : Popup, IEnhancedScrollerDelegate
    {
        ...
        private void Start()
        {
            ...
            ipfEnterName.characterLimit = 15;
        ...
        protected virtual void OnInputNameCallback(string value)
        {
            if (value.Length >= 16)
            {
                ...
                if (!txtWarning.gameObject.activeSelf)
        ...
        private void DisplayWarning(string message)
        {
            ...
            _sequenceTxtWarning.Append(txtWarning.transform.TweenLocalScale(new Vector3(1.1f, 1.1f, 1.1f), 0.12f)
                .SetEase(Ease.Parabolic));
            _sequenceTxtWarning.Append(txtWarning.transform.TweenLocalScale(new Vector3(1f, 1f, 1f), 0.12f)
                .SetEase(Ease.Linear));
        ...
        private bool IsElementSelected(string code)
        {
            return _selectedCountry.Equals(code);
        }
